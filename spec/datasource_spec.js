...
var testRespSimpleGauge = require('./test_response_simple_gauge.json');
...
describe('GenericDatasource', function() {
  ...
  // NOTE: simple gauge
  it('should return the server results when a target is set for simple gauge visualisation', function(done) {
    ctx.backendSrv.datasourceRequest = function(request) {
      return ctx.$q.resolve({
        _request: request,
